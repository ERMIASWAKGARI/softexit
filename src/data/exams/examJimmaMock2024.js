const examJimmaMock2024 = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ['Firewall', 'Router', 'Switch', 'Transparent Bridge'],
      correctAnswerIndex: 0,
      explanation:
        'Firewalls are specifically designed to monitor and control incoming and outgoing network traffic based on security rules.',
    },
    {
      id: '12',
      ...
      correctAnswerIndex: 3,
      explanation:
        'Fiber optic cables provide the highest bandwidth and are ideal for long-distance communication with minimal signal loss.',
    },
    {
      id: '13',
    ...
    },
    {
      ...
      options: ['ACK and FIN', 'PSH and RST', 'SYN and ACK', 'SYN and URG'],
      correctAnswerIndex: 2,
      explanation:
        'The three-way handshake uses SYN (synchronize) and ACK (acknowledge) flags to establish a reliable connection.',
    },
    {
      id: '16',
      ...
      correctAnswerIndex: 2,
      explanation:
        'UDP is preferred for applications where speed is more important than reliability, such as video streaming or online gaming.',
    },
    {
      id: '17',
      ...
      correctAnswerIndex: 1,
      explanation:
        'The primary key is the main identifier for a table that uniquely identifies each record.',
    },
    {
      id: '18',
      ...
      correctAnswerIndex: 1,
      explanation:
        'Data independence allows changes to one level of the database (physical or logical) without affecting other levels.',
    },
    {
      id: '19',
      ...
      correctAnswerIndex: 2,
      explanation:
        'Weak entity sets depend on strong entity sets for their identification and cannot exist independently.',
    },
    {
      id: '20',
      ...
      correctAnswerIndex: 1,
      explanation:
        'The UPDATE statement with WHERE clause is the most efficient way to modify specific records in a database.',
    },
    {
      id: '21',
      ...
      correctAnswerIndex: 2,
      explanation:
        'This is the correct SQL syntax for inserting a new record with specified column values.',
    },
    {
      id: '22',
      ...
      correctAnswerIndex: 3,
      explanation:
        'The immediate priority in a breach is to identify and contain the threat to prevent further damage.',
    },
    {
      id: '23',
      ...
      correctAnswerIndex: 3,
      explanation:
        'Data independence is not a challenge specific to multicore systems but rather a database concept.',
    },
    {
      id: '24',
      ...
      correctAnswerIndex: 0,
      explanation:
        'These four conditions (mutual exclusion, hold and wait, no preemption, circular wait) must all be present for deadlock to occur.',
    },
    {
      id: '25',
      ...
      correctAnswerIndex: 2,
      explanation:
        'Priority scheduling allows critical tasks with deadlines to be assigned higher priority and executed first.',
    },
    {
      id: '26',
      ...
      correctAnswerIndex: 0,
      explanation:
        'Corrupted files can cause applications to malfunction and potentially crash the system.',
    },
    {
      id: '27',
      ...
      correctAnswerIndex: 1,
      explanation:
        'Disk scheduling algorithms optimize the order of I/O requests to minimize seek time and improve performance.',
    },
    {
      id: '28',
      ...
      correctAnswerIndex: 0,
      explanation:
        'Access control mechanisms enforce security policies by restricting access to authorized users only.',
    },
    {
      id: '29',
      ...
      correctAnswerIndex: 1,
      explanation:
        "Ransomware typically encrypts victim's files and demands payment for the decryption key.",
    },
    {
      id: '30',
    ...
    },
    {
      ...
      correctAnswerIndex: 3,
      explanation:
        'Brute force attacks systematically try all possible combinations to break encryption.',
    },
    {
      id: '32',
    ...
    },
    {
      ...
      correctAnswerIndex: 2,
      explanation:
        'The plaintext can be calculated using the RSA decryption formula.',
    },
    {
      id: '34',
      text: 'What is the first step in the program development process?',
      options: ['Coding', 'Problem definition', 'Testing', 'Deployment'],
      correctAnswerIndex: 1,
      explanation:
        'Clearly defining the problem is essential before any development can begin.',
    },
    {
      id: '35',
      ...
      correctAnswerIndex: 2,
      explanation:
        'Following the arithmetic operations step-by-step leads to e = 7.',
    },
    {
      id: '36',
      ...
      correctAnswerIndex: 2,
      explanation:
        'The do-while loop checks the condition after executing the block, ensuring at least one execution.',
    },
    {
      id: '37',
      text: 'Which of the following is a valid IDENTIFIER in c++?',
      options: ['Abc7_4', 'ABC_41fa', 'ASC_45fa', '6AbCD'],
      correctAnswerIndex: 0,
      explanation:
        'Valid C++ identifiers must start with a letter or underscore, not a number.',
    },
    {
      id: '38',
      text: 'Which of the following is the correct syntax to read the single character to console in the C++ language?',
      options: ['get(ch)', 'Scanf(ch)', 'Read ch()', 'Getline vh()'],
      correctAnswerIndex: 0,
      explanation:
        'get(ch) is the correct method for reading a single character in C++.',
    },
    {
      id: '39',
      text: 'What will be the output of the following C++ code?\n\nchar str[] = "password";\nif(strcmp(str, "password")){\n    cout<<"Valid";\nelse {\n    cout<<"Invalid";\n}',
      options: ['Run-time Error', 'Valid', 'Invalid', 'No output'],
      correctAnswerIndex: 2,
      explanation:
        'strcmp returns 0 when strings match, so the if condition evaluates to false.',
    },
    {
      id: '40',
      ...
      correctAnswerIndex: 3,
      explanation:
        'The loop executes 7 times, printing values from 20 down to 2 in steps of 3.',
    },
    {
      id: '41',
      ...
      options: ['Functions', 'Loops', 'Objects', 'Inheritance'],
      correctAnswerIndex: 2,
      explanation:
        'Objects allow bundling of data (items) and operations (add/remove/calculate) together.',
    },
    {
      id: '42',
      ...
      correctAnswerIndex: 2,
      explanation:
        'Random number generation is fundamental to creating unpredictable passwords.',
    },
    {
      id: '43',
      ...
      correctAnswerIndex: 3,
      explanation:
        'Print statements help trace execution flow and identify where the process fails.',
    },
    {
      id: '44',
      ...
      correctAnswerIndex: 1,
      explanation:
        'Researching existing solutions is often the most efficient first step in problem-solving.',
    },
    {
      id: '45',
      text: 'Which data structure is best suited for representing a SOCIAL NETWORK where users can follow each other?',
      options: ['Array', 'Stack LIFO', 'Graph', 'Linked List'],
      correctAnswerIndex: 2,
      explanation:
        'Graphs naturally model relationships (edges) between entities (nodes) like in social networks.',
    },
    {
      id: '46',
      ...
      correctAnswerIndex: 0,
      explanation:
        'The nested loops result in quadratic time complexity O(n²).',
    },
    {
      id: '47',
      ...
      options: ['Stack LIFO', 'Queue FIFO', 'Array', 'Linked List'],
      correctAnswerIndex: 3,
      explanation:
        'Linked lists provide O(1) insertion/deletion at any point once the position is located.',
    },
    {
      id: '48',
      ...
      correctAnswerIndex: 1,
      explanation:
        'Time complexity analyzes runtime, space complexity analyzes memory requirements.',
    },
    {
      id: '49',
      ...
      correctAnswerIndex: 1,
      explanation:
        'Binary search halves the search space each iteration, resulting in O(log n) time.',
    },
    {
      id: '50',
      ...
      options: ['Stack LIFO', 'Queue', 'Binary Search Tree', 'Hash Table'],
      correctAnswerIndex: 1,
      explanation:
        'Queues naturally model FIFO (first-in-first-out) systems like traffic flow.',
    },
    {
      id: '51',
      ...
      correctAnswerIndex: 0,
      explanation:
        'Methods define the behaviors that all instances of a class can perform.',
    },
    {
      id: '52',
    ...
    },
    {
      ...
      correctAnswerIndex: 3,
      explanation:
        'Exception handling provides mechanisms to gracefully handle runtime errors.',
    },
    {
      id: '54',
      ...
      correctAnswerIndex: 3,
      explanation:
        "Inheritance promotes code reuse by allowing Square to leverage Rectangle's functionality.",
    },
    {
      id: '55',
      text: 'Which of the following GUI components is primarily used to display non-editable text on the screen?',
      options: ['JButton', 'JTextField', 'JLabel', 'Menu'],
      correctAnswerIndex: 2,
      explanation:
        'JLabel is designed specifically for displaying read-only text in GUI applications.',
    },
    {
      id: '56',
      ...
      correctAnswerIndex: 1,
      explanation:
        'Effective stakeholder management involves understanding and balancing diverse stakeholder needs.',
    },
    {
      id: '57',
    ...
    },
    {
      ...
      correctAnswerIndex: 2,
      explanation:
        'Formal change control processes ensure changes are properly evaluated and documented.',
    },
    {
      id: '60',
    ...
    },
    {
      ...
      correctAnswerIndex: 1,
      explanation:
        'BDD bridges communication between technical and non-technical stakeholders through natural language.',
    },
    {
      id: '62',
      ...
      correctAnswerIndex: 2,
      explanation:
        'Agile testing aligns with iterative development and continuous integration practices.',
    },
    {
      id: '63',
      ...
      correctAnswerIndex: 2,
      explanation:
        "Path testing aims to exercise every possible route through a program's control flow.",
    },
    {
      id: '64',
      ...
      correctAnswerIndex: 1,
      explanation:
        'The Delphi Technique uses expert consensus to identify risks anonymously.',
    },
    {
      id: '65',
    ...
    },
    {
      ...
      correctAnswerIndex: 1,
      explanation:
        'Software architecture establishes the fundamental organization of a system.',
    },
    {
      id: '67',
      ...
      correctAnswerIndex: 1,
      explanation:
        'The shared data pattern centralizes data access for multiple components.',
    },
    {
      id: '68',
      ...
      correctAnswerIndex: 2,
      explanation:
        '1-tier architecture bundles all components together in a single system.',
    },
    {
      id: '69',
      ...
      correctAnswerIndex: 1,
      explanation:
        'Developers are implementers, not stakeholders who derive value from the system.',
    },
    {
      id: '70',
      ...
      correctAnswerIndex: 3,
      explanation:
        "Maintenance typically consumes the majority of a system's lifecycle costs.",
    },
    {
      id: '71',
      ...
      correctAnswerIndex: 1,
      explanation:
        'UI design occurs later in the development process after requirements are established.',
    },
    {
      id: '72',
      ...
      correctAnswerIndex: 1,
      explanation:
        'Users often struggle to articulate their needs clearly and completely.',
    },
    {
      id: '73',
      ...
      correctAnswerIndex: 1,
      explanation:
        'Clear, concise requirements avoid ambiguity and improve understanding.',
    },
    {
      id: '74',
    ...
    },
    {
      ...
      correctAnswerIndex: 2,
      explanation:
        'Effective change management balances stakeholder needs with project constraints.',
    },
    {
      id: '76',
      ...
      correctAnswerIndex: 3,
      explanation:
        'Intents are the primary mechanism for activity communication in Android.',
    },
    {
      id: '77',
      ...
      correctAnswerIndex: 3,
      explanation:
        'IntentFilters declare what types of intents a component can respond to.',
    },
    {
      id: '78',
      ...
      correctAnswerIndex: 3,
      explanation:
        'onResume() is called when the activity returns to the foreground after being paused.',
    },
    {
      id: '79',
      text: 'How many manifest files one can find in an android application?',
      options: ['2', '3', '1', 'as per the application'],
      correctAnswerIndex: 2,
    ...
    },
    {
      ...
      correctAnswerIndex: 2,
      explanation:
        'setOnClickListener defines the code to execute when the button is clicked.',
    },
    {
      id: '81',
      ...
      correctAnswerIndex: 3,
      explanation:
        'The test() method is called on the regex pattern with the string as argument.',
    },
    {
      id: '82',
    ...
    },
    {
      ...
      correctAnswerIndex: 0,
      explanation:
        'Path types determine how the browser resolves the location of linked resources.',
    },
    {
      id: '84',
      ...
      correctAnswerIndex: 2,
      explanation:
        'box-sizing determines whether padding and border are included in element dimensions.',
    },
    {
      id: '85',
      ...
      correctAnswerIndex: 0,
      explanation:
        'ID selectors target unique elements with a specific id attribute.',
    },
    {
      id: '86',
      ...
      correctAnswerIndex: 3,
      explanation:
        'time()+3600 sets expiration to current time plus 3600 seconds (1 hour).',
    },
    {
      id: '87',
    ...
    },
    {
      ...
      correctAnswerIndex: 0,
      explanation:
        'The <img> tag with src attribute is the correct HTML syntax for images.',
    },
    {
      id: '89',
    ...
    },
    {
      ...
      options: ['Defects', 'Failures', 'Errors', 'Bugs'],
      correctAnswerIndex: 3,
      explanation:
        'The term "bugs" is commonly used to describe coding mistakes.',
    },
    {
      id: '91',
      ...
      correctAnswerIndex: 2,
      explanation:
        'Fix backlog tracks the accumulation of unresolved issues over time.',
    },
    {
      id: '92',
      ...
      correctAnswerIndex: 2,
      explanation:
        'Maintenance metrics help quantify and improve maintenance effectiveness.',
    },
    {
      id: '93',
      ...
      correctAnswerIndex: 2,
      explanation:
        'Legal concerns often involve licensing and intellectual property rights.',
    },
    {
      id: '94',
      ...
      correctAnswerIndex: 0,
      explanation:
        'Source code translation is a separate process from re-engineering.',
    },
    {
      id: '95',
      ...
      correctAnswerIndex: 3,
      explanation:
        'The Spiral Model explicitly incorporates risk analysis in each iteration.',
    },
    {
      id: '96',
      text: 'Which of the following is NOT a core principle of good software design?',
      options: ['Modularization', 'Reusability', 'Redundancy', 'Cohesion'],
      correctAnswerIndex: 2,
    ...
    },
    {
      ...
      correctAnswerIndex: 1,
      explanation:
        'Risk management systematically addresses potential project risks.',
    },
    {
      id: '98',
      ...
      options: ['Coding', 'Testing', 'Project management', 'Design'],
      correctAnswerIndex: 2,
      explanation:
        'Project management activities span the entire software lifecycle.',
    },
    {
      id: '99',
      ...
      correctAnswerIndex: 1,
      explanation:
        'Code reviews help catch issues before they enter the main codebase.',
    },
    {
      id: '100',
      ...
      correctAnswerIndex: 0,
      explanation:
        'Good processes should enhance, not reduce, team communication.',
    },
  ],
}
