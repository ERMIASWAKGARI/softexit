const moee2 = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ['a. Counting', 'b. Linked-list', 'c. Grouping', 'd. Deadlock'],
      correctAnswerIndex: 2,
      explanation:
        'Grouping is a memory management technique that stores multiple free block addresses together.',
    },
    {
      id: '13',
    ...
    },
    {
      ...
      correctAnswerIndex: 2,
      explanation:
        'Instance diagrams show static structure, not dynamic behavior.',
    },
    {
      id: '15',
      ...
      correctAnswerIndex: 1,
      explanation:
        'This is the only specific host address among the options (others are network addresses or within a large range).',
    },
    {
      id: '16',
      text: 'Which file system can be used to change certain kernel parameters at runtime using sysctl command?',
      options: ['a. Procfs', 'b. Ext4', 'c. Ext3', 'd. Sysfs'],
      correctAnswerIndex: 0,
      explanation:
        'Procfs provides access to kernel parameters and process information.',
    },
    {
      id: '17',
      ...
      correctAnswerIndex: 1,
      explanation:
        'Total participation means every entity must participate in the relationship (every dorm must have at least one student).',
    },
    {
      id: '18',
      ...
      correctAnswerIndex: 2,
      explanation:
        'Quad-trees divide space into four quadrants, hence four children per node.',
    },
    {
      id: '19',
      ...
      correctAnswerIndex: 2,
      explanation:
        'Primary keys must be NOT NULL to uniquely identify each record.',
    },
    {
      id: '20',
      ...
      options: ['a. Bootloader', 'b. BIOS', 'c. Bootstrap', 'd. Cache memory'],
      correctAnswerIndex: 2,
    ...
    },
    {
      ...
      correctAnswerIndex: 0,
      explanation:
        'Back end component is architecture-specific, not fundamental to all programs.',
    },
    {
      id: '23',
      ...
      correctAnswerIndex: 1,
      explanation:
        'FileInputStream is specifically for reading bytes from files.',
    },
    {
      id: '24',
      ...
      correctAnswerIndex: 0,
      explanation:
        'Multiple views allow different perspectives on the same data.',
    },
    {
      id: '25',
      ...
      correctAnswerIndex: 3,
      explanation:
        'Without break, execution "falls through" to the next case/default.',
    },
    ...
    },
    {
      ...
      correctAnswerIndex: 1,
      explanation:
        'Validation confirms the product meets user needs and requirements.',
    },
    {
      id: '28',
      ...
      correctAnswerIndex: 0,
      explanation:
        'Application layer enables communication between applications on different hosts.',
    },
    {
      id: '29',
    ...
    },
    {
      ...
      correctAnswerIndex: 2,
      explanation:
        'Informed searches use heuristics and are admissible if they never overestimate cost.',
    },
    {
      id: '33',
    ...
    },
    {
      ...
      correctAnswerIndex: 2,
      explanation:
        'LSAs performance depends on initial state and neighborhood definition.',
    },
    {
      id: '36',
      ...
      correctAnswerIndex: 1,
      explanation:
        'Ethical engineers should only accept work within their competence.',
    },
    {
      id: '37',
    ...
    },
    {
      ...
      correctAnswerIndex: 3,
      explanation:
        'Multiprogramming uses scheduling, not directly queue data structures.',
    },
    {
      id: '39',
    ...
    },
    {
      ...
      correctAnswerIndex: 2,
      explanation:
        'Verifiability ensures requirements can be objectively tested/checked.',
    },
    {
      id: '41',
      ...
      correctAnswerIndex: 3,
      explanation:
        'System design is a later phase, while others are requirements engineering activities.',
    },
    {
      id: '42',
      ...
      correctAnswerIndex: 3,
      explanation:
        'Inheritance primarily enables code reuse through hierarchical relationships.',
    },
    {
      id: '43',
      ...
      correctAnswerIndex: 1,
      explanation:
        "Dijkstra's processes nodes as discovered, UCS uses priority queue.",
    },
    {
      id: '44',
      ...
      correctAnswerIndex: 0,
      explanation:
        'Overfitting occurs when model learns training data noise/particularities.',
    },
    {
      id: '45',
      ...
      correctAnswerIndex: 2,
      explanation:
        'Integration testing verifies component interactions in combined operation.',
    },
    {
      id: '46',
    ...
    },
    {
      ...
      correctAnswerIndex: 1,
      explanation:
        'Polymorphism enables methods with same name but different signatures.',
    },
    {
      id: '48',
      ...
      correctAnswerIndex: 2,
      explanation:
        'Logical errors produce incorrect results without syntax/runtime errors.',
    },
    {
      id: '49',
      ...
      correctAnswerIndex: 2,
      explanation:
        'Standard for loop syntax: initialization; condition; increment.',
    },
    {
      id: '50',
      ...
      options: ['a. Inherited', 'b. Protected', 'c. Public', 'd. Private'],
      correctAnswerIndex: 1,
    ...
    },
    {
      ...
      correctAnswerIndex: 2,
      explanation:
        'Logical Link Control (LLC) handles protocol identification and encapsulation.',
    },
    {
      id: '52',
      text: 'Which of the following keywords is used to define a variable in Javascript?',
      options: ['a. const', 'b. val', 'c. let', 'd. int'],
      correctAnswerIndex: 2,
      explanation:
        'let and const are used in JavaScript (var is older). "val" and "int" are not JavaScript keywords.',
    },
    {
      id: '53',
      ...
      options: ['a. Precision', 'b. Recall', 'c. F-measure', 'd. Accuracy'],
      correctAnswerIndex: 1,
      explanation:
        'Recall measures the ratio of correctly identified defects to all actual defects.',
    },
    {
      id: '54',
      ...
      correctAnswerIndex: 0,
      explanation:
        'AI systems consist of agents that perceive and act upon environments.',
    },
    {
      id: '55',
      text: 'The CSS property used to specify the transparency of an element is?',
      options: ['a. Background', 'b. Alpha', 'c. Opacity', 'd. Transparency'],
      correctAnswerIndex: 2,
    ...
    },
    {
      ...
      correctAnswerIndex: 3,
      explanation:
        'Localizing critical operations minimizes latency and improves performance.',
    },
    {
      id: '57',
      ...
      correctAnswerIndex: 0,
      explanation:
        'Data storage is an implementation detail, not an architectural decision.',
    },
    {
      id: '58',
      text: 'Which of the following is not a data link layer technology?',
      options: ['a. OSPF', 'b. PPP', 'c. Frame-relay', 'd. VLAN'],
      correctAnswerIndex: 0,
      explanation:
    ...
    },
    {
      ...
      correctAnswerIndex: 2,
      explanation:
        'Card Layout is not a standard Android layout (CardView exists but is different).',
    },
    {
      id: '61',
    ...
    },
    {
      ...
      options: ['a. Group By', 'b. UNIQUE', 'c. PRIMARY', 'd. DISTINCT'],
      correctAnswerIndex: 3,
    ...
    },
    {
      ...
      options: ['a. Bagging', 'b. Lasso', 'c. Random forest', 'd. Boosting'],
      correctAnswerIndex: 1,
    ...
    },
    {
      ...
      correctAnswerIndex: 3,
      explanation:
        'Clear notation and semantics improve architectural understanding.',
    },
    {
      id: '66',
      text: 'You have received an e-mail which is unsolicited and commercially known as?',
      options: ['a. Adware', 'b. Trash', 'c. Spam', 'd. Wana Cry'],
      correctAnswerIndex: 2,
    ...
    },
    {
      ...
      options: ['a. O(n^5)', 'b. O(n^2)', 'c. O(n logn)', 'd. O(n^7)'],
      correctAnswerIndex: 0,
    ...
    },
    {
      ...
      correctAnswerIndex: 2,
      explanation:
        'onCreate() is the first lifecycle callback in Android activities.',
    },
    {
      id: '70',
    ...
    },
    {
      ...
      correctAnswerIndex: 3,
      explanation:
        'Confidentiality breaches involve unauthorized information disclosure.',
    },
    {
      id: '72',
    ...
    },
    {
      ...
      correctAnswerIndex: 1,
      explanation:
        'This insertion order would produce the given hash table layout with linear probing.',
    },
    {
      id: '75',
    ...
    },
    {
      ...
      options: ['a. Process', 'b. Project', 'c. Program', 'd. Portfolio'],
      correctAnswerIndex: 1,
      explanation:
        'PMI defines a project as a temporary endeavor with unique deliverables.',
    },
    {
      id: '77',
      text: 'A system software that resides in main memory is',
      options: ['a. Executor', 'b. Compiler', 'c. Loader', 'd. Linker'],
      correctAnswerIndex: 2,
